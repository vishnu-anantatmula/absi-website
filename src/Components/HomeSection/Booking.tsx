...
export function Booking() {
  return (
    <div className="grid place-items-center gap-8 px-4 md:px-12 mt-4 mb-2">
      ...
      <div className="xl:basis-full">
        <Link
          to="/contact"
          className="font-semibold bg-blue-950 py-3 px-6 rounded-lg shadow-md basis-full text-white text-xl hover:ring-2 hover:ring-cyan-950">
          Book a Consultation
        </Link>
      </div>
    </div>
